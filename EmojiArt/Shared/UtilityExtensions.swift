...
//just an easy way to remove and insert elements from Set
extension Set where Element: Identifiable {
    mutating func toggleMatching(matching element: Element) {
...
//just an easy way to make string which containing only unique characters
extension String {
